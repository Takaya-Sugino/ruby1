...
# withdraw 50
bank_account_balanace = 51
if bank_account_balanace > 50
    bank_account_balanace = bank_account_balanace - 50
    puts "you have withdrawn $50, new balance is #{bank_account_balanace}"
else 
